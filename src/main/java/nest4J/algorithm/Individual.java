 ...
 * @author yisa
 */
public class Individual  implements Comparable<nest4J.algorithm.Individual>{
    public List<NestPath> placement;
    public List<Integer> rotation;
    public double fitness ;


    public Individual(nest4J.algorithm.Individual individual){
    ...
    public int compareTo(nest4J.algorithm.Individual o) {
    ...
    public boolean equals(Object obj) {
        nest4J.algorithm.Individual individual = (nest4J.algorithm.Individual) obj;
