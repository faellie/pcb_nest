 ...
 * @author yisa
 */
public class NestPath  implements Comparable<nest4J.data.NestPath>{
    private List<Segment> segments;
    private List<nest4J.data.NestPath> children;
    private nest4J.data.NestPath parent;
    ...
    public boolean equals(Object obj) {
        nest4J.data.NestPath nestPath = (nest4J.data.NestPath) obj;
    ...
    public nest4J.data.NestPath getParent() {
        return parent;
    }

    public void setParent(nest4J.data.NestPath parent) {
        this.parent = parent;
    }

    public void addChildren(nest4J.data.NestPath nestPath){
    ...
    public String toString() {
        ...
        count = 0 ;
        for(nest4J.data.NestPath nestPath: children){
            res += "children "+ count +"\n";
            count++;
    ...
    public List<nest4J.data.NestPath> getChildren() {
        return children;
    }

    public void setChildren(List<nest4J.data.NestPath> children) {
    ...
    public NestPath(){
        offsetX = 0;
        offsetY = 0;
        children = new ArrayList<nest4J.data.NestPath>();
    ...
    public NestPath(nest4J.data.NestPath srcNestPath){
        segments = new ArrayList<Segment>();
        ...
        for(nest4J.data.NestPath nestPath: srcNestPath.getChildren()){
            nest4J.data.NestPath child = new nest4J.data.NestPath(nestPath);
            child.setParent(this);
            children.add(child);
        }
    }

    public static nest4J.data.NestPath cleanNestPath(nest4J.data.NestPath srcPath){
        /**
         ...
         */
        nest4J.data.NestPath cleanPath = CommonUtil.Path2NestPath(clean);
    ...
    public int compareTo(nest4J.data.NestPath o) {
